...
**Intern:** Kongari Udayasree  
**Organization:** SkillCraft Technology  
**Duration:** June 15 – July 15, 2026  
...
- Cleaned and analyzed Superstore Sales Data using Microsoft Excel
- Created Pivot Tables and Charts
- Visualized Total Sales, Profit by Category, and Sales Trends
- Used Conditional Formatting to highlight high/low performers
- 🎥 [Watch Video](https://youtu.be/ReSVFYJqXA0?si=5duGEsQdmJqUt_XM)

### Task 02 – Data Cleaning and Preparation 🧹
- Loaded Global Superstore dataset in Python (Google Colab)
...
## 🎥 Task Videos
- [Task 01 - Excel Sales Dashboard](https://youtu.be/ReSVFYJqXA0?si=5duGEsQdmJqUt_XM)
- [Task 02 - Data Cleaning](https://youtu.be/fTpQ_VYkLho?si=eRTOGRzi1UQPkLpJ)
- [Task 03 - Interactive Visualization](https://youtu.be/Fx7YCxyX5Ag?si=go86nbtA6SyIK9Qv)
- [Task 04 - Business Insights EDA](https://youtu.be/HhP4KTBJgpE?si=D4iEcrMsLiDVi9ed)

---

## 🏷️ Tags
`data-analysis` `python` `excel` `power-bi` `eda` `skillcraft` `internship`
